...
sed -e 's/<Patch>pardus\/kernel-config\.patch<\/Patch>/<Patch>pardus\/kernel-config-64bit\.patch<\/Patch>/' -e 's/<Patch level="1">pardus\/linux-2\.6-add-fujitsu-amilo-74xx-rfkill-drivers\.patch<\/Patch>/<Patch level="1">pardus\/linux-2\.6-add-fujitsu-amilo-74xx-rfkill-drivers\.patch<\/Patch>\n\n            <\!-- Patch for Pardus64 to FSAM74XX devices, adding "select check_signature" -->\n            <Patch level="1">pardus\/fsam74XX-select_check_signature\.patch<\/Patch>\n/' $source/kernel/default/kernel/pspec.xml > $destination/kernel/default/kernel/pspec.xml
